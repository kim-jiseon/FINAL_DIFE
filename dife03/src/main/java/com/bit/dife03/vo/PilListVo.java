...
public class PilListVo {
	...
	public PilListVo(int list_no, String pil_no, String mem_name, String pil_title, int pil_cateInfo, String pil_photo,
			String pil_locInfo, String pil_info, int pil_star, String pil_detInfo, String pil_ok, String pil_portfolio,
			String pil_profile, int pil_career, String pil_drone, String pil_qualification, String pil_contact,
			String pil_intro, String first, Date first_time, String last, Date last_time) {
		super();
	...
	public String getPil_detInfo() {
		return pil_detInfo;
	}
	public void setPil_detInfo(String pil_detInfo) {
		this.pil_detInfo = pil_detInfo;
	}
	...
	public String toString() {
		return "PilListVo [list_no=" + list_no + ", pil_no=" + pil_no + ", mem_name=" + mem_name + ", pil_title="
				+ pil_title + ", pil_cateInfo=" + pil_cateInfo + ", pil_photo=" + pil_photo + ", pil_locInfo="
				+ pil_locInfo + ", pil_info=" + pil_info + ", pil_star=" + pil_star + ", pil_detInfo=" + pil_detInfo
				+ ", pil_ok=" + pil_ok + ", pil_portfolio=" + pil_portfolio + ", pil_profile=" + pil_profile
				+ ", pil_career=" + pil_career + ", pil_drone=" + pil_drone + ", pil_qualification=" + pil_qualification
				+ ", pil_contact=" + pil_contact + ", pil_intro=" + pil_intro + ", first=" + first + ", first_time="
				+ first_time + ", last=" + last + ", last_time=" + last_time + "]";
	}
